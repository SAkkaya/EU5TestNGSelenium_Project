...
public class WebTablesExample {
    ...
    public void printTableSize(){
        ...
        // numbers of rows without header (we prefer this)
    ...
    public void getASinglecell(){
        ...
        WebElement singleCell = driver.findElement(By.xpath("//table[@id='table1']/tbody/tr[3]/td[5]"));   // tr==> row number   td= column number
        System.out.println("singleCell.getText() = " + singleCell.getText()); //singleCell.getText() = http://www.jdoe.com
    ...
    public void getCellInRelationToAnotherCellInSameRow(){
        ...
        String firstName="Jason";
                                                                //  ../ parent a gidip tekrar diger child a iniyoruz
        String xpath ="//table[@id='table1']//td[.='"+firstName+"']/../td[3]";  //Jason text ine gore bulduk
