...
public class NoSelectDropdown {
    ...
    public void test1() {
        ...
        //search by class name ==> should be same for each dropdown elements


        //get the options with findElements method and finding common locator between them
        List<WebElement> dropdownOptions = driver.findElements(By.className("dropdown-item")); // we used regular find elements method , we did not use selenium Select class
