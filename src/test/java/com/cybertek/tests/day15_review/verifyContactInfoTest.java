...
import com.cybertek.assignments.hw_day15_contactInfo.ContactsPages;
...
public class verifyContactInfoTest extends TestBase {
    ...
    public void contactDetailsTest(){
        ...
        String expectedFullName = "Mariam BrackstoneA";
        String actualFullName = contactInfoPage.fullName.getText();

        extentLogger.info("VerifyContactInformationTest full name is "+ expectedFullName);
        ...
        Assert.assertEquals(contactInfoPage.email.getText(),"mbrackstone9@example.com","VerifyContactInformationTest email");
